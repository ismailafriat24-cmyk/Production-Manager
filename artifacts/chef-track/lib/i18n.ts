...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    // Welcome
    tagline: "Production & team management",
    imTheManager: "I'm the Manager",
    managerDesc: "Create a workspace for your organization. You'll get a join code to share with your team.",
    ...
    workshopNameLabel: "Organization / company name",
    workshopNamePlaceholder: "e.g. Sunrise Operations",
    yourName: "Your name",
  ...
  fr: {
    ...
    tagline: "Gestion de la production et des équipes",
    imTheManager: "Je suis le responsable",
    managerDesc: "Créez un espace de travail pour votre organisation. Vous recevrez un code à partager avec votre équipe.",
    ...
    signInSub: "Connectez-vous à votre espace de travail",
    manager: "Responsable",
    operator: "Opérateur",
    ...
    workshopNameLabel: "Nom de l'organisation / entreprise",
    workshopNamePlaceholder: "ex. Sunrise Operations",
    yourName: "Votre nom",
  ...
  es: {
    ...
    tagline: "Gestión de producción y equipos",
    imTheManager: "Soy el gerente",
    managerDesc: "Crea un espacio de trabajo para tu organización. Recibirás un código para compartir con tu equipo.",
    ...
    signInSub: "Inicia sesión en tu espacio de trabajo",
    manager: "Gerente",
    operator: "Operador",
    ...
    workshopNameLabel: "Nombre de la organización / empresa",
    workshopNamePlaceholder: "ej. Sunrise Operations",
    yourName: "Tu nombre",
  ...
  ar: {
    ...
    tagline: "إدارة الإنتاج والفرق",
    imTheManager: "أنا المدير",
    managerDesc: "أنشئ مساحة عمل لمؤسستك. ستحصل على رمز انضمام لمشاركته مع فريقك.",
    ...
    signInSub: "تسجيل الدخول إلى مساحة عملك",
    manager: "مدير",
    operator: "موظف",
    ...
    workshopNameLabel: "اسم المؤسسة / الشركة",
    workshopNamePlaceholder: "مثال: عمليات الشروق",
    yourName: "اسمك",
